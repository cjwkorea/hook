        ...
        <div className="d-flex justify-content-around">
          {isLoading ? (
            <Card style={{ width: "25rem" }}>
              <Card.Img variant="top" src="https://w7.pngwing.com/pngs/480/736/png-transparent-loading-logo-computer-icons-address-bar-loading-miscellaneous-text-rectangle-thumbnail.png" />
              <Card.Body>
